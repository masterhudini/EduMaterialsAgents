...
2. `[TK-DECISION: CLAIM-ASSESSMENT-MODEL]`, do podjęcia podczas przeglądu 1b1 Claim Verification.
...
- `shared/scripts/research/research_flow.py`, realne scoping, agent invocation i fan-out/fan-in,
...
1. Universal Reviewer i `review-research-output`.
2. Research Planner i `plan-research-scope`.
3. Domain Research oraz query i metadata discovery.
4. Canonical Sources i citation expansion.
5. Recent Developments.
6. Candidate Source Index, ranking, coverage i Human Source Selection Gate.
7. Paper Retrieval oraz deterministyczne OA resolution, download i validation.
8. Paper Review oraz deterministyczny indeks tekstu PDF.
9. Claim Verification i `assess-claim-evidence`; w tym kroku zamknąć
   `[TK-DECISION: CLAIM-ASSESSMENT-MODEL]`.
10. Research Synthesizer i Human Research Gate.
