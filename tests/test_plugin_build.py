...
def test_build_renders_all_skills_without_mutating_sources(tmp_path):
    ...
    for host in ("claude", "codex"):
        ...
        for relative in (
            ...
            "shared/contracts/a07_deep_dive.schema.json",
            "shared/contracts/a09_synthesis_task.schema.json",
            ...
            "shared/scripts/g02/a09_runner.py",
            "shared/scripts/g02/a09_synthesis.py",
