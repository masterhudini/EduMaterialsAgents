---
name: g02-a08-assess-claim-evidence
description: Assess one approved claim or tight claim group from reviewed evidence cards using separate evidence, currency, pedagogical, controversy and confidence dimensions. Use after G02-A07 Paper Review; preserve contrary evidence and unresolved states.
---
...
`g02-a08-claim-verification` before freezing field values or compatibility mappings.
